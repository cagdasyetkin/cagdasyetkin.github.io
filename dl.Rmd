...
This data is about patients taking an appointment from the doctors. They are labeled as 'no-show' when they have an appointment but never showed up. The original data is on Kaggle.
...
But how many items do we have? OK it has a nice Github site. We have 10 classes again.
...
```
I used 5 epochs in the end. I tried 25, 30, 60 and 35 epochs also. I started to flatten out after 3 epochs already
```{r}
history <- model %>% fit(
...
CNN acc is 98.13% and loss is 5.7%. This is a much better result than deep neural net! Amazing!
