...
<img src="final_files/sample2.png" alt="data" height="350" width="550">
...
####*The Chronicles of Mezzopotamia*
...
We started from knowing almost nothing and got to a point where we can write a fictional story in a Bronze Age Middle East setting. We were able to understand the building blocks of an ancient trade network and get its sentiments. We have a fairly good understanding of how those operations felt like. We could identify the trade lords (ruling families) and the most important person in the network who makes this trade engine work. We became good friends with him.


My **special thanks** to [Kerem Cosar](https://twitter.com/a_kerem_cosar "KeremLink") from University of Virginia who gave me the text files. He is one of the authors of the paper; Trade, Merchants, and the Lost Cities of the Bronze Age which made me start typing the first line of code.
