...
I am going to use a special lexicon built for modern financial analysis. I am curious how it can perform on 4000 year old commercial records.  

```{r, warning=FALSE, message=FALSE, fig.width=9, fig.height=4, message=FALSE}
library(gridExtra)
...
I apllied also Topic Modeling to the text and it turns out there is only 1 topic here: Trade
